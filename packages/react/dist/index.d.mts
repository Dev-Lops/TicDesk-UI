...
declare const StyledSelect: _stitches_react_types_styled_component.StyledComponent<"select", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface SelectInputProps extends ComponentProps<typeof StyledSelect> {
    options: {
        value: string;
        label: string;
    }[];
...
export { Avatar, type AvatarProps, Box, type BoxProps, Button, type ButtonProps, Heading, type HeadingProps, SelectInput, type SelectInputProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps };
