...
var SelectInput = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SelectWrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(StyledSelect, __spreadProps(__spreadValues({}, props), { disabled, children: options.map((option) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: option.value, children: option.label }, option.value)) })) });
};
